...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, CalcRequest> consumerFactory() {
        JsonDeserializer<CalcRequest> deserializer = new JsonDeserializer<>(CalcRequest.class);
        deserializer.addTrustedPackages("*");

        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "calculator-service");
